      ...
      <div className="relative z-10 container mx-auto px-4 py-16 lg:py-24">
        ...
        <div ref={titleRef} className="text-center mb-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6">
            <span className="text-[#AAD468]">Design</span>
            <span className="text-gray-300">.</span>
            <span className="ml-4 text-[#AAD468]">Develop</span>
            <span className="text-gray-300">.</span>
            <span className="ml-4 text-[#AAD468]">Deploy</span>
            <span className="text-gray-300">.</span>
          </h1>
        </div>
        ...
        <div ref={brandsRef} className="text-center">
          <div className="grid grid-cols-3 lg:grid-cols-5 gap-8 place-items-center max-w-6xl mx-auto">
